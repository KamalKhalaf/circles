...
class NearbyFragmentPhase2 : Fragment(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GpsUtils.onGpsListener {
...
//        mMap!!.isMyLocationEnabled = true
    ...
    companion object {
        fun newInstance(tokenType: String, accsToken: String): NearbyFragmentPhase2 {
            val args = Bundle()
            val fragment = NearbyFragmentPhase2()
        ...
        fun newInstance2(tokenType: String, accsToken: String): NearbyFragmentPhase2 {
            val args = Bundle()
            val fragment = NearbyFragmentPhase2()
