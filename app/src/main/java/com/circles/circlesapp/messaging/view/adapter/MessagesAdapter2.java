...
import com.circles.circlesapp.databinding.OtherUserMessageItem2Binding;
...
public class MessagesAdapter2 extends BaseListAdapter<Message, OtherUserMessageItem2Binding> implements MySeekBarCallback {
    ...
    public MessagesAdapter2(Context context, List<Message> messages, CustomOnClickListener<MessageFiles> voteClickCallback) {
        super(DIFF_CALLBACK);
    ...
    public int getLayoutIdForPosition(int position) {
        return R.layout.other_user_message_item2;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull DataBindingViewHolder<Message, OtherUserMessageItem2Binding> holder, int position) {
...
//                    (ViewGroup.MarginLayoutParams) holder.b.mainConstraint.getLayoutParams();
//            layoutParams.setMargins(80, 32, 20, 8);
//            holder.b.mainConstraint.requestLayout();
...
//            ViewGroup.MarginLayoutParams layoutParams =
//                    (ViewGroup.MarginLayoutParams) holder.b.mainConstraint.getLayoutParams();
//            layoutParams.setMargins(50, 32, 80, 8);
//            holder.b.mainConstraint.requestLayout();
...
//            holder.b.mainConstraint.setBackground(getContext().getResources().getDrawable(R.drawable.rounded_white_backg));
        ...
        if (m.isImage() && !m.getType().equals("voting")) {
            ...
            holder.b.alyVideo.setVisibility(View.GONE);
            holder.b.seekBarView.setVisibility(View.GONE);
            holder.b.pollCv.setVisibility(View.GONE);
            holder.b.layoutMsgData.setVisibility(View.GONE);

            MessageFiles file = m.getFirstFile();
            holder.b.messageText.setText(m.getMessageBody());

            if (m.getFiles().size() > 1) {
                holder.b.rvPhotos.setVisibility(View.VISIBLE);
                holder.b.singLay.setVisibility(View.GONE);

                holder.b.rvPhotos.setHasFixedSize(true);
                holder.b.rvPhotos.setLayoutManager(new GridLayoutManager(context, 2, GridLayoutManager.VERTICAL, false));
                PhotoAdapter photoAdapter = new PhotoAdapter(m.getFiles(), context);
                holder.b.rvPhotos.setAdapter(photoAdapter);

            } else {
                holder.b.rvPhotos.setVisibility(View.GONE);
                holder.b.singLay.setVisibility(View.VISIBLE);
                ...
                if (m.getFiles().get(0).message_file != null && !m.getFiles().get(0).message_file.equals("")) {
                    Glide.with(context).applyDefaultRequestOptions(requestOptions).asBitmap()
                            ...
                            .listener(new RequestListener<Bitmap>() {
                                ...
                                public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Bitmap> target, boolean isFirstResource) {
                                    holder.b.progressBarload2.setVisibility(View.GONE);
                                    return false;
                                }
                    ...
                    holder.b.progressBarload2.setVisibility(View.GONE);
                    Glide.with(context).load(R.drawable.sign_up_profile).into(holder.b.img);
                }
...
//
        ...
        //regionVideo
            ...
            holder.b.pollCv.setVisibility(View.GONE);
            holder.b.alyVideo.setVisibility(View.VISIBLE);
            holder.b.seekBarView.setVisibility(View.GONE);
...
//                holder.b.mpwVideoPlayer.autoStartPlay(m.getFiles().get(0).message_file, MxVideoPlayer.SCREEN_LAYOUT_LIST,
//                        "name");
//
//                Glide.with(context)
//                        .load("http://img3.yytcdn.com/video/mv/140108/850708/D81901436FF172396A44128BAC8C3707_240x135.jpeg")
//                        .into(holder.b.mpwVideoPlayer.mThumbImageView);
//
//                holder.b.mpwVideoPlayer.setOnClickListener(v -> {
//
...
//                });
        ...
        //regionIsPoll
            ...
            holder.b.pollImageLeft.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final Dialog dialog = new Dialog(context, R.style.coupon_Dialog);
                    dialog.setContentView(R.layout.dialog_zoom_in);
            ...
            holder.b.pollImageRight.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final Dialog dialog = new Dialog(context, R.style.coupon_Dialog);
                    dialog.setContentView(R.layout.dialog_zoom_in);
        ...
        //regionText
            ...
            holder.b.seekBarView.setVisibility(View.GONE);
            holder.b.imageCv.setVisibility(View.GONE);
            holder.b.layoutMsgData.setVisibility(View.VISIBLE);
            holder.b.messageText.setText(m.getMessageBody());
        }
